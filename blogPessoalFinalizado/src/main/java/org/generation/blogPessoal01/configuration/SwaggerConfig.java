	package org.generation.blogPessoal01.configuration;
	...
	public class SwaggerConfig {
		...
		public Docket api() {
			return new Docket(DocumentationType.SWAGGER_2)
					...
					.basePackage("org.generation.blogPessoal01.controller"))
		...
		private static Contact contact() {
			return new Contact( "Felipe Januario Domingues",
								"https://github.com/djan-domingues",
